...
public class AssistantProfessor extends Employee {
    ...
    public AssistantProfessor(String name, int id, String addr, String mail, long mobile, double basicPay) {
    ...
    public String getPaySlip() {
        ...
        String slip = "Designation: Assistant Professor\n"; // Note the changed designation
